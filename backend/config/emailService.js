...
class EmailService {
  ...
  generateAdminEmailTemplate({ name, email, message }) {
    ...
    const sanitizedEmail = this.sanitizeHtml(email);
    ...
    return `<div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
      ...
      <div style="background: #f9fafb; padding: 25px; border-radius: 0 0 8px 8px; border: 1px solid #e5e7eb;">
        <div style="margin-bottom: 15px;">
          ...
          <span style="color: #6b7280;">${sanitizedName}</span>
        </div>
        <div style="margin-bottom: 15px;">
          <strong style="color: #374151;">Email:</strong>
          <a href="mailto:${email}" style="color: #3b82f6; text-decoration: none;">${sanitizedEmail}</a>
        </div>
        <div style="margin-bottom: 15px;">
        ...
        <div style="margin-top: 20px; padding-top: 15px; border-top: 1px solid #e5e7eb; font-size: 12px; color: #9ca3af;">
          Sent from portfolio contact form at ${currentTime}
        </div>
      </div>
    </div>`;
  }
  ...
  generateAutoReplyTemplate({ name, profileImageUrl }) {
    ...
    return `<div style="font-family: 'Segoe UI', Arial, sans-serif; max-width: 650px; margin: 0 auto; padding: 24px; border-radius: 14px; background: #ffffff; box-shadow: 0 4px 16px rgba(0,0,0,0.08);">
      <div style="background: linear-gradient(135deg, #4f46e5, #3b82f6); padding: 30px 20px 20px; border-radius: 12px 12px 0 0; text-align: center; color: #fff;">
        <img src="${profileImageUrl}" alt="Naveen Agarwal" style="width: 90px; height: 90px; border-radius: 50%; border: 3px solid #fff; margin-bottom: 15px; object-fit: cover;" />
        <h1 style="margin: 0; font-size: 22px;">✨ Thanks for Your Message!</h1>
      </div>
      <div style="padding: 25px; color: #333;">
        <p style="font-size: 16px; line-height: 1.6; margin-bottom: 15px;">Hi <strong>${sanitizedName}</strong>, 👋</p>
        <p style="font-size: 15px; line-height: 1.6; color: #555; margin-bottom: 15px;">I truly appreciate you reaching out through my portfolio website. 🙌 Your message has been received, and I'll personally get back to you within <strong>24–48 hours</strong>.</p>
        <p style="font-size: 15px; line-height: 1.6; color: #555; margin-bottom: 20px;">Meanwhile, feel free to check out my projects or connect with me directly using the links below.</p>
        <div style="text-align: center; margin: 30px 0;">
          <a href="${this.portfolioUrl}" target="_blank" style="display: inline-block; margin: 8px; padding: 12px 24px; font-size: 15px; font-weight: 600; color: #fff; background: #4f46e5; border-radius: 8px; text-decoration: none; box-shadow: 0 2px 6px rgba(0,0,0,0.2);">🌐 Visit Portfolio</a>
          <a href="${this.linkedinUrl}" target="_blank" style="display: inline-block; margin: 8px; padding: 12px 24px; font-size: 15px; font-weight: 600; color: #fff; background: #2563eb; border-radius: 8px; text-decoration: none; box-shadow: 0 2px 6px rgba(0,0,0,0.2);">💼 Connect on LinkedIn</a>
        </div>
        <div style="background: #f8fafc; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #10b981;">
          <p style="font-size: 14px; color: #374151; margin: 0; line-height: 1.5;"><strong>💡 Quick Tip:</strong> For urgent inquiries, feel free to connect with me directly on LinkedIn for faster response times.</p>
        </div>
        <p style="font-size: 15px; line-height: 1.6; color: #555; margin-bottom: 10px;">Looking forward to connecting soon! 🚀</p>
        <p style="font-weight: bold; font-size: 15px; margin-top: 20px; color: #374151;">Best regards,<br/><span style="color: #4f46e5;">Naveen Agarwal</span></p>
      </div>
      <div style="font-size: 12px; color: #9ca3af; text-align: center; margin-top: 20px; border-top: 1px solid #e5e7eb; padding-top: 15px;">⚡ This is an automated response from Naveen Agarwal's portfolio system.<br/><span style="color: #6b7280;">Sent on ${currentDate}</span></div>
    </div>`;
  }
